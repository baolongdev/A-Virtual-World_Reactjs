import { getIntersection, dot, normalize, subtract, perpendicular, lerp, distance } from "../world";
...
export class Sensor {
    ...
    private getReading(ray, roadBorders, minDotAngle) {
        let touches = [];
