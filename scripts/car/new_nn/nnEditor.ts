import { Point, Segment, getNearestPoint, getNearestSegment } from "../../world";
import { drawArrow2 } from "../utils";
import { Visualizer } from "../visualizer";
import { NN } from "./nn";

export class NNEditor {
   viewport: any;
   canvas: any;
   graph: any;
   ctx: any;
   ...
   static graphFromCar(car, cWidth, cHeight) {
      ...
      const inputLabels = ["â¬‰", "â¬†", "â¬ˆ"].concat(car.brainOptions.extraInputs);
