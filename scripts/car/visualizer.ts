...
import { getNearestPoint, getNearestSegment, lerp, Point, Segment } from "../world";
...
export class Visualizer {
    ...
    static handleMouseMove(evt) {
        Visualizer.mouse = new Point(evt.offsetX, evt.offsetY);
    ...
    static inputPoints(mouse: Point, inputPoints: any, arg2: number): any {
